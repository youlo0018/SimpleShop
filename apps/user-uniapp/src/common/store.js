...
export const applyTheme = theme => {
  const value = theme || {}
  const applied = {
    primary: value.primary || '#00c1a2',
    background: value.background || '#f5f5f5',
    tabColor: value.tabColor || value.primary || '#00c1a2'
  }
...
export const getTheme = () => uni.getStorageSync('theme') || { primary: '#00c1a2', background: '#f5f5f5', tabColor: '#00c1a2' }
